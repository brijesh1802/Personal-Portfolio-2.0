import maheLogo from '../images/MAHE_Color.png';
import mgmLogo from '../images/ymgm-logo.jpg';
...
export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1WJWVZM4lileWvq3C0H54Nm18PfgjxCqD/view?usp=drivesdk",
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Designed and implemented a responsive frontend for a SaaS platform offering streamlined business solutions. Used modern frameworks and tools to ensure fast loading times and intuitive user experiences.",
    image: "https://github.com/brijesh1802/Streamerzz/blob/main/public/Streamerzz.png?raw=true",
    tags: ["React", "CSS", "JavaScript","Framer-Motion"],
    category: "frontend development",
    github: "https://github.com/brijesh1802/Streamerzz",
  ...
  },
  {
    ...
    description:
      "Developed an interactive Sudoku game with user statistics tracking. Integrated Firebase Realtime Database to store user progress, statistics, and game data. Implemented features like game pause, undo, and resume for an enhanced user experience.",
    image: "https://github.com/JnaneshAmin25/Sudoku/blob/master/sudoku.jpg?raw=true",
    tags: ["Java", "Android Studio", "Firebase", "Game Development"],
    category: "game development",
    github: "https://github.com/JnaneshAmin25/Sudoku",
    webapp: null,
  },
  {
    id: 6,
    ...
    description:
      "Developed a RESTful API for managing a bookstore's inventory and user transactions. The API supports CRUD operations for books, user authentication, and seamless order management. Integrated JWT for authentication and MongoDB for storage, and followed clean code principles to ensure scalability.",
    image: "https://github.com/brijesh1802/Book-Store-API/blob/main/bookstore.jpg?raw=true",
    tags: ["Node.js", "Express.js", "MongoDB", "JWT", "API Integration"],
    category: "backend development",
    github: "https://github.com/brijesh1802/Book-Store-API",
    webapp: null,
  },
  {
    id: 7,
